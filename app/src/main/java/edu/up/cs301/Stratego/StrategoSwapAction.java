...
/**
 * For swapping pieces in Stratego
 *
 ...
 * @author Jack Volonte
 */
public class StrategoSwapAction extends GameAction {
     ...
     */
    public StrategoSwapAction(GamePlayer player, int squareSrc, int squareDest) {
        super(player);
